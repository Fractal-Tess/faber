...
impl fmt::Display for TaskStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            TaskStatus::ResourceLimitExceeded => write!(f, "resource_limit_exceeded"),
            TaskStatus::Timeout => write!(f, "timeout"),
            TaskStatus::MemoryLimitExceeded => write!(f, "memory_limit_exceeded"),
            TaskStatus::CpuLimitExceeded => write!(f, "cpu_limit_exceeded"),
        }
    }
}

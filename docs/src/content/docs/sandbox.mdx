---
title: 'Sandbox Crate'
description: 'Documentation for the faber-sandbox crate'
---

# Sandbox Crate

The `faber-sandbox` crate provides the core sandboxing functionality for Faber, implementing Linux namespaces, cgroups, and seccomp to create secure, isolated execution environments for untrusted code.
...
```rust
use faber_sandbox::{Container, ContainerConfig, SandboxError};
